 ...
 * 16 ms = ~60 Hz: plynniejszy odczyt dotyku i animacje (mamy zapas RAM/PSRAM). */
...
/* Wlaczone wylacznie kroje uzywane przez aplikacje — kazda kolejna czcionka
 * to dziesiatki KB w pamieci programu (oszczednosc ~400 KB lacznie). */
