...
<main class="app">
  ...
  <div id="otherModal" class="modal" role="presentation" aria-hidden="true">
    ...
    <div class="card modal-dialog">
      ...
      <div class="actions"><button class="milk wide" data-action="diaper">PIELUCHA</button><button class="wide" data-action="pumping">ODCIAG POKARMU</button><button class="wide" id="sleepBtn" data-action="sleep-open" style="background:#6E5FA6">SEN</button></div>
    </div>
  </div>
  ...
  <div id="sleepModal" class="modal" role="presentation" aria-hidden="true">
    ...
    <div class="card modal-dialog">
      ...
      <button type="button" class="wide" id="sleepToggleBtn" data-action="sleep" style="background:#6E5FA6;margin-top:12px">ZAŚNIJ</button>
...
function renderSleep(){
  ...
  if(btn){btn.textContent=d.sleepInProgress?'OBUDŹ':'ZAŚNIJ';btn.style.background=d.sleepInProgress?'#E0A93F':'#6E5FA6'}
  ...
  if(st==='spi'){
    ...
    big.textContent='Brak danych snu';barTxt.textContent='Dotknij ZAŚNIJ, aby rozpocząć';win.textContent='';
  }
  // Bilans dnia
