...
<main class="app">
  ...
  <div id="otherModal" class="modal" role="presentation" aria-hidden="true">
    ...
    <div class="card modal-dialog">
      ...
      <div class="actions"><button class="milk wide" data-action="diaper">PIELUCHA</button><button class="wide" data-action="pumping">ODCIAG POKARMU</button></div>
    </div>
  </div>
...
const modals=['calendarModal','detailModal','chartModal','diaperModal','chart5Modal','otherModal','weightModal','sleepModal'];
